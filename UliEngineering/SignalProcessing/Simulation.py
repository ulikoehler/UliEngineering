...
def generate_sinewave(frequency, samplerate, amplitude=1., length=1., phaseshift=0, offset=0):
    """
    Generate a sine wave of a specific frequency of a specific length
...
def generate_squarewave(frequency, samplerate, amplitude=1., length=1., phaseshift=0, offset=0):
    """
    Generate a square wave of a specific frequency of a specific length
