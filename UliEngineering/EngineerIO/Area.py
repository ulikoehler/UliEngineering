...
def area_unit_infos():
    return [
        ...
        UnitAlias('mm²', aliases=['mm^2', 'square millimeter', 'square millimeters',
                                  'square mm', 'sq mm', 'mm sq', 'mm squared', 'millimeter squared']),
        UnitAlias('cm²', aliases=['cm^2', 'square centimeter', 'square centimeters',
                                  'square cm', 'sq cm', 'cm sq', 'cm squared',
                                  'centimeter squared', 'centimeters squared']),
        UnitAlias('dm²', aliases=['dm^2', 'square decimeter', 'square decimeters',
                                  'square dm', 'sq dm', 'dm sq', 'dm squared',
                                  'decimeter squared', 'decimeters squared']),
        UnitAlias('km²', aliases=['km^2', 'square kilometer', 'square kilometers',
                                  'square km', 'sq km', 'km squared', 'km sq',
                                  'kilometers sq', 'kilometers squared']),
        UnitAlias('µm²', aliases=['µm^2', 'um²', 'um^2', 'square micrometer',
                                  'square micrometers', 'square µm', 'sq µm', 'sq um',
                                  'um sq', 'µm sq', 'µm squared',
                                  'micrometer squared', 'micrometers squared']),
        UnitAlias('nm²', aliases=['nm^2', 'square nanometer', 'square nanometers',
                                  'square nm', 'sq nm', 'nm sq', 'nm squared',
                                  'nanometer squared', 'nanometers squared']),
