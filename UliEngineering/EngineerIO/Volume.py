...
def volume_unit_infos():
    return [
        ...
        UnitAlias('mm³', aliases=['mm^3', 'cubic millimeter', 'cubic millimeters',
                                  'cubic mm', 'cu mm', 'mm cu', 'mm cubed', 'millimeter cubed']),
        UnitAlias('cm³', aliases=['cm^3', 'cubic centimeter', 'cubic centimeters',
                                  'cubic cm', 'cu cm', 'cm cu', 'cm cubed',
                                  'centimeter cubed', 'centimeters cubed', 'cc']),
        UnitAlias('dm³', aliases=['dm^3', 'cubic decimeter', 'cubic decimeters',
                                  'cubic dm', 'cu dm', 'dm cu', 'dm cubed',
                                  'decimeter cubed', 'decimeters cubed']),
        UnitAlias('km³', aliases=['km^3', 'cubic kilometer', 'cubic kilometers',
                                  'cubic km', 'cu km', 'km cubed', 'km cu',
                                  'kilometers cu', 'kilometers cubed']),
        UnitAlias('µm³', aliases=['µm^3', 'um³', 'um^3', 'cubic micrometer',
                                  'cubic micrometers', 'cubic µm', 'cu µm', 'cu um',
                                  'um cu', 'µm cu', 'µm cubed',
                                  'micrometer cubed', 'micrometers cubed']),
        UnitAlias('nm³', aliases=['nm^3', 'cubic nanometer', 'cubic nanometers',
                                  'cubic nm', 'cu nm', 'nm cu', 'nm cubed',
                                  'nanometer cubed', 'nanometers cubed']),
