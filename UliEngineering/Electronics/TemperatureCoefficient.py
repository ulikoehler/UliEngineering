...
def value_at_temperature(nominal: NormalizableArgument, temperature: NormalizableArgument,
                         coefficient: NormalizableArgument = "100 ppm",
                         tref: NormalizableArgument = "25°C"):
    """
...
def value_range_over_temperature(nominal: NormalizableArgument, coefficient: str|float = "100ppm",
                                  tolerance: NormalizableArgument = "0 %",
                                  tmin: NormalizableArgument = "-40 °C",
                                  tmax: NormalizableArgument = "85 °C",
                                  tref: NormalizableArgument = "25 °C",
