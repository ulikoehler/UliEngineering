...
class TestRNAMolecularWeight(unittest.TestCase):
    ...
    def test_equal_fractions(self):
        mw = rna_molecular_weight(40, equal_rna_fractions)
        expected = (
            10 * 329.2 +
            10 * 306.2 +
            10 * 345.2 +
    ...
    def test_zero_length(self):
        mw = rna_molecular_weight(0, equal_rna_fractions)
...
class TestDNAWeightConcentration(unittest.TestCase):
    def test_mol_per_liter(self):
        ...
        result = dnarna_weight_concentration_from_concentration("1 mol/l", 1, equal_dna_fractions)
    ...
    def test_micromolar(self):
        ...
        result = dnarna_weight_concentration_from_concentration("1 uM", 10, equal_dna_fractions)
        if isinstance(result, (list, np.ndarray)):
    ...
    def test_list_input(self):
        ...
        result = dnarna_weight_concentration_from_concentration(["1 uM", "2 uM"], 5, equal_dna_fractions)
        if isinstance(result, (list, np.ndarray)):
    ...
    def test_ndarray_input(self):
        ...
        result = dnarna_weight_concentration_from_concentration(arr, 2, equal_dna_fractions)
