...
from UliEngineering.EngineerIO.Length import normalize_length, EngineerLengthIO, convert_length_to_meters, convert_length_to_unit
import unittest
...
class TestLength(unittest.TestCase):
    ...
    def test_length_normalization(self):
        ...
        assert_approx_equal(normalize_length("1.0 um"), 1e-6)
        assert_approx_equal(normalize_length("1.0 μm"), 1e-6)
    ...
    def test_convert_length_to_meters(self):
        ...
        assert_approx_equal(convert_length_to_meters(1.0, "um"), 1e-6)
        assert_approx_equal(convert_length_to_meters(1.0, "μm"), 1e-6)
