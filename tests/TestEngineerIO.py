...
class TestEngineerIO(object):
    ...
    def test_split_input(self):
        ...
        assert_tuple_equal(self.io.split_input("1234k"), SplitResult('', '1234', 'k', '', ''))
        assert_tuple_equal(self.io.split_input("1234kΩ"), SplitResult('', '1234', 'k', '', 'Ω'))
        assert_tuple_equal(self.io.split_input("1.234kΩ"), SplitResult('', '1.234', 'k', '', 'Ω'))
        assert_tuple_equal(self.io.split_input("1,234kΩ"), SplitResult('', '1.234', 'k', '', 'Ω'))
        assert_tuple_equal(self.io.split_input("1,234.56kΩ"), SplitResult('', '1234.56', 'k', '', 'Ω'))
        assert_tuple_equal(self.io.split_input("1k234"), SplitResult('', '1.234', 'k', '', ''))
        assert_tuple_equal(self.io.split_input("1k234Ω"), SplitResult('', '1.234', 'k', '', 'Ω'))
        assert_tuple_equal(self.io.split_input("1,234.56Ω"), SplitResult('', '1234.56', '', '', 'Ω'))
        ...
        assert_tuple_equal(self.io.split_input("-1,234.56kΩ"), SplitResult('', '-1234.56', 'k', '', 'Ω'))
        assert_tuple_equal(self.io.split_input("-1e3kΩ"), SplitResult('', '-1e3', 'k', '', 'Ω'))
        assert_tuple_equal(self.io.split_input("1e-3kΩ"), SplitResult('', '1e-3', 'k', '', 'Ω'))
        assert_tuple_equal(self.io.split_input("-4e6nA"), SplitResult('', '-4e6', 'n', '', 'A'))
    ...
    def test_split_unit(self):
        ...
        assert_tuple_equal(self.io.split_unit("1234k"), UnitSplitResult('1234k', '', ''))
        assert_tuple_equal(self.io.split_unit("1234kΩ"), UnitSplitResult('1234k', '', 'Ω'))
        assert_tuple_equal(self.io.split_unit("1.234kΩ"), UnitSplitResult('1.234k', '', 'Ω'))
        assert_tuple_equal(self.io.split_unit("1,234kΩ"), UnitSplitResult('1,234k', '', 'Ω'))
        assert_tuple_equal(self.io.split_unit("1,234.56kΩ"), UnitSplitResult('1,234.56k', '', 'Ω'))
        assert_tuple_equal(self.io.split_unit("1k234"), UnitSplitResult('1k234', '', ''))
        assert_tuple_equal(self.io.split_unit("1k234Ω"), UnitSplitResult('1k234', '',  'Ω'))
        assert_tuple_equal(self.io.split_unit("1,234.56Ω"), UnitSplitResult('1,234.56', '', 'Ω'))
        assert_tuple_equal(self.io.split_unit("1A"), UnitSplitResult('1', '', 'A'))
        assert_tuple_equal(self.io.split_unit("1"), UnitSplitResult('1', '', ''))
        assert_tuple_equal(self.io.split_unit("1k234 Ω"), UnitSplitResult('1k234', '', 'Ω'))
        assert_tuple_equal(self.io.split_unit("-1,234.56kΩ"), UnitSplitResult('-1,234.56k', '', 'Ω'))
        assert_tuple_equal(self.io.split_unit("-1e3kΩ"), UnitSplitResult('-1e3k', '', 'Ω'))
        assert_tuple_equal(self.io.split_unit("1e-3kΩ"), UnitSplitResult('1e-3k', '', 'Ω'))
        assert_tuple_equal(self.io.split_unit("-4e6nA"), UnitSplitResult('-4e6n', '', 'A'))
