...
class TestEngineerIO(object):
    ...
    def testSplitSuffixSeparator(self):
        ...
        assert_is_none(splitSuffixSeparator("1k2.4"))
        assert_is_none(splitSuffixSeparator("k2"))
    ...
    def test_auto_suffix_1d(self):
        ...
        assert_equal(auto_suffix_1d(arr), (1e3, "m"))
        arr = 1e9 * np.arange(-4., 5., .5)
        assert_equal(auto_suffix_1d(arr), (1e-9, "G"))
        arr = np.arange(1000., 2000., 5)
        assert_equal(auto_suffix_1d(arr), (1e-3, "k"))
        # Test out of limits
        arr = 1e-40 * np.arange(-4., 5., .5)
        assert_equal(auto_suffix_1d(arr), (1e24, "y"))
        arr = 1e40 * np.arange(-4., 5., .5)
        assert_equal(auto_suffix_1d(arr), (1e-21, "Y"))
