...
class TestLarmorFrequency(unittest.TestCase):
    def test_larmor_frequency_h1(self):
        ...
        self.assertAlmostEqual(larmor_frequency(1., nucleus_larmor_frequency=NucleusLarmorFrequency.H1), 42.57638474)
        self.assertAlmostEqual(larmor_frequency(2.2, nucleus_larmor_frequency=NucleusLarmorFrequency.H1), 2.2*42.57638474)
